...
model_name = "/work/projects/project01762/CyBERT/model/cybert_ranada"

wandb.init(project="CyBERT", entity="few_shot", group="MSExchange_Ranada")
...
os.mkdir("cybert/model/MSExchange_Ranada" + "_" + timestamp)
model.save_pretrained("cybert/model/MSExchange_Ranada" + "_" + timestamp + "/")
