...
model_name = "bert-base-uncased-mumtaz"
...
os.mkdir("cybert/model/MSExchange_" + model_name + "_" + timestamp)
model.save_pretrained("cybert/model/MSExchange_" + model_name + "_" + timestamp + "/")
