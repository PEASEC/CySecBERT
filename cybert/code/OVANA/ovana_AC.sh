...
srun python cybert/code/OVANA/run_ner_AC_Ranada.py \
        --model_name_or_path "/work/projects/project01762/CyBERT/model/cybert_ranada" \
        --task_name "ner" \
        --train_file "cybert/input/NER/tagged_all_AC/train.json" \
        --validation_file "cybert/input/NER/tagged_all_AC/test.json" \
        --do_train --do_eval --evaluation_strategy "epoch" \
        --num_train_epochs 4 --per_device_train_batch_size 16 \
        --output_dir "cybert/model/OVANA_AC_Ranada" \
