...
model_name = "/work/projects/project01762/CyBERT/model/cybert_v100_r"
...
os.mkdir("cybert/model/CySecAlert_CyBERT" + "_" + timestamp)
model.save_pretrained("cybert/model/CySecAlert_CyBERT" + "_" + timestamp + "/")
